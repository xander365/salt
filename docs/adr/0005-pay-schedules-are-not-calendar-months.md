...
- Since ADR-0007 gave PAYE and SSC separate effective-date axes, the period end date now selects *each* of them independently. The keying rule is unchanged; it simply applies twice.
